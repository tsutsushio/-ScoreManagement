...
<style>
    ...
    .btn-primary { background-color: #d2691e; color: white; border: 2px solid #d2691e; }
...
<div class="result-box">
    ...
    <div class="btn-group">
        <a href="${pageContext.request.contextPath}/action/TeacherCreate.action" class="btn btn-primary">${retryBtnLabel}</a>
